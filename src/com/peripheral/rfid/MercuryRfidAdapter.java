...
public class MercuryRfidAdapter implements ReadablePeripheral, RfidConfigurable {

    private final DeviceModelEntry model;
    private final SerialConnectionConfig serialConfig;
    private MercuryRfidReader reader;

    public MercuryRfidAdapter(DeviceModelEntry model, SerialConnectionConfig serialConfig) {
        this.model = model;
